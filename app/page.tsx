    ...
    return (
      <main className="min-h-screen flex items-center justify-center px-4">
        <div className="w-full max-w-sm text-center">
          ...
          <h1 className="text-2xl font-800 text-brand-400 mb-3">Ride Booked!</h1>
          <p className="text-zinc-300 text-lg leading-relaxed">
            Thank you{" "}
            <span className="text-white font-700">{form.name}</span>, we will
            call you shortly.
          </p>
          <p className="mt-3 text-zinc-500 text-sm">
            Please keep your phone reachable on{" "}
            <span className="font-600 text-zinc-300">{form.phone}</span>.
          </p>
          <button
            onClick={() => {
              setForm(INITIAL);
  ...
  return (
    <main className="min-h-screen px-4 py-10 flex flex-col items-center">
      ...
      <div className="w-full max-w-sm mb-8 text-center">
        ...
        <h1 className="mt-2 text-3xl font-800 tracking-tight">
          Book a{" "}
      ...
      >
        ...
        <div>
          <label htmlFor="drop" className="field-label">
            Drop Location{" "}
            <span className="normal-case text-zinc-600 font-400">(optional)</span>
          </label>
          <input
            id="drop"
            name="drop"
